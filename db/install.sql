...
(6, 'admin_rooms_controller', 'Räume administrieren'),
...
(10, 'admin_groups_controller', 'Manage usergroups and their rights'),
(11, 'user_questions', 'Let users ask questions'),
(12, 'admin_questions_controller', 'Answer user''s questions'),
(13, 'admin_faq', 'Edit FAQs'),
(14, 'admin_news_controller', 'Administrate the news section'),
(15, 'news_comments', 'User can comment news'),
(16, 'admin_user_controller', 'Administrate the angels'),
(17, 'user_meetings', 'Lists meetings (news)'),
(18, 'admin_language_controller', 'Translate the system'),
(19, 'admin_log_controller', 'Display recent changes'),
(20, 'user_wakeup', 'User wakeup-service organization'),
(21, 'admin_import_controller', 'Import rooms and shifts from pentabarf'),
...
(27, 'admin_arrive_controller', 'Mark angels when they arrive.'),
(28, 'admin_shifts_controller', 'Create shifts'),
(30, 'ical', 'iCal shift export'),
(31, 'admin_active_controller', 'Mark angels as active and if they got a t-shirt.'),
(32, 'admin_free_controller', 'Show a list of free/unemployed angels.'),
